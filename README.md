...
- **Structure Validation**: Check group hierarchy based on file version (v0.1.2 or v0.2.0)
...
- **file.version**: Must be "0.1.2" or "0.2.0"
- **data_level**: Must be 0, 1, or 2

### Structure Checks (v0.1.2)
...
**On Tags** (e.g., `v0.1.2`): Executables are automatically attached to the GitHub Release.
